...
public class ExportEntryRequestImageOptions {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.format, exportEntryRequestImageOptions.format)
                && Objects.equals(this.jpegCompressionLevel, exportEntryRequestImageOptions.jpegCompressionLevel)
                && Objects.equals(this.includeAnnotations, exportEntryRequestImageOptions.includeAnnotations)
                && Objects.equals(this.convertPdfAnnotations, exportEntryRequestImageOptions.convertPdfAnnotations)
                && Objects.equals(this.pagePrefix, exportEntryRequestImageOptions.pagePrefix)
                && Objects.equals(this.includeRedactions, exportEntryRequestImageOptions.includeRedactions)
                && Objects.equals(this.watermark, exportEntryRequestImageOptions.watermark);
    }
    ...
    public String toString() {
        ...
        sb.append("    jpegCompressionLevel: ")
                .append(toIndentedString(jpegCompressionLevel))
                .append("\n");
        sb.append("    includeAnnotations: ")
                .append(toIndentedString(includeAnnotations))
                .append("\n");
        sb.append("    convertPdfAnnotations: ")
                .append(toIndentedString(convertPdfAnnotations))
                .append("\n");
        sb.append("    pagePrefix: ").append(toIndentedString(pagePrefix)).append("\n");
        sb.append("    includeRedactions: ")
                .append(toIndentedString(includeRedactions))
                .append("\n");
