...
public class Link {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, link.id)
                ...
                && Objects.equals(this.sourceId, link.sourceId)
                && Objects.equals(this.sourceFullPath, link.sourceFullPath)
                && Objects.equals(this.sourceLabel, link.sourceLabel)
                && Objects.equals(this.sourceLink, link.sourceLink)
                && Objects.equals(this.targetId, link.targetId)
                && Objects.equals(this.targetFullPath, link.targetFullPath)
                && Objects.equals(this.targetLabel, link.targetLabel)
                && Objects.equals(this.targetLink, link.targetLink)
                && Objects.equals(this.linkDefinitionId, link.linkDefinitionId)
                && Objects.equals(this.linkDefinitionDescription, link.linkDefinitionDescription)
                && Objects.equals(this.customProperties, link.customProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("    linkDefinitionId: ")
                .append(toIndentedString(linkDefinitionId))
                .append("\n");
        sb.append("    linkDefinitionDescription: ")
                .append(toIndentedString(linkDefinitionDescription))
                .append("\n");
