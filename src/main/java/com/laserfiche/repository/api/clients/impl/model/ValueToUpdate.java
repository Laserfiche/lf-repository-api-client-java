...
public class ValueToUpdate {
  ...
  /**
   * Returns he value assigned to the field at the position specified.
   *
   * @return value
   */
  ...
  /**
   * Returns he position of the value in the field. This is 1-indexed for multi value field. It will
   * be ignored for single value field.
   *
   * @return position
   */
  @Schema(
