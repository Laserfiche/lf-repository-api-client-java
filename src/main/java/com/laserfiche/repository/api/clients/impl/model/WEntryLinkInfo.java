...
public class WEntryLinkInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(linkId, sourceId, sourceFullPath, sourceLabel, targetId, targetFullPath, targetLabel, description, linkTypeDescription, linkProperties, sourceLink, targetLink);
  }
