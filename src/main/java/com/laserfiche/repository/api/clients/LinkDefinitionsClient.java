...
public interface LinkDefinitionsClient {
  ...
  /**
   * Provides the functionality to iteratively (i.e. through paging) call {@link #getLinkDefinitions
   * getLinkDefinitions}, and apply a function on the response of each iteration.
   *
