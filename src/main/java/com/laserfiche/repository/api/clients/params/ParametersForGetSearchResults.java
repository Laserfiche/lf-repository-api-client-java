...
public class ParametersForGetSearchResults {
   ...
   * value should be a standard language tag. The formatFields query parameter must be set to true,
  ...
  /**
   * Sets the value of the searchToken parameter and returns the current object, to enable chaining
   * further setters.
   *
  ...
  /**
   * Sets the value of the formatFields parameter and returns the current object, to enable chaining
   * further setters.
   *
   * @param formatFields Boolean for if field values should be formatted. Only applicable if Fields
   *     are specified.
   * @return {@link ParametersForGetSearchResults} The return value
   */
   ...
   *     formatting. The value should be a standard language tag. The formatFields query parameter
   *     must be set to true, otherwise culture will not be used for formatting.
   * @return {@link ParametersForGetSearchResults} The return value
   */
  ...
  /**
   * Sets the value of the top parameter and returns the current object, to enable chaining further
   * setters.
   *
  ...
  /**
   * Sets the value of the skip parameter and returns the current object, to enable chaining further
   * setters.
   *
   ...
   * further setters.
   *
   * @param count Indicates whether the total count of items within a collection are returned in the
   *     result.
   * @return {@link ParametersForGetSearchResults} The return value
   */
