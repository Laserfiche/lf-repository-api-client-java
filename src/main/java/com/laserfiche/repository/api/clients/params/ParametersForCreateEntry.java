...
/**
 * The encapsulated parameters for {@link com.laserfiche.repository.api.clients.impl.EntriesClientImpl#createEntry(ParametersForCreateEntry) createEntry}.
 */
public class ParametersForCreateEntry {
    ...
    private CreateEntryRequest requestBody;
     ...
     * @return {@link ParametersForCreateEntry} The return value
     */
     ...
     * @return {@link ParametersForCreateEntry} The return value
     */
    public ParametersForCreateEntry setEntryId(Integer entryId) {
    ...
    public ParametersForCreateEntry setRequestBody(CreateEntryRequest requestBody) {
