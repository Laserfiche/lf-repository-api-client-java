...
public class TagDefinitionsClientImpl extends ApiClient implements TagDefinitionsClient {
    ...
    public TagDefinitionsClientImpl(
    ...
    @Override
    public ODataValueContextOfIListOfWTagInfo getTagDefinitions(
            ParametersForGetTagDefinitions parameters) {
        return doGetTagDefinitions(
                baseUrl + "/v1/Repositories/{repoId}/TagDefinitions", parameters);
    }
    ...
    @Override
    public ODataValueContextOfIListOfWTagInfo getTagDefinitionsNextLink(
    ...
    public WTagInfo getTagDefinitionById(ParametersForGetTagDefinitionById parameters) {
        ...
        Function<HttpResponse<Object>, WTagInfo> parseResponse =
                (HttpResponse<Object> httpResponse) -> {
                    Object body = httpResponse.getBody();
                    Map<String, String> headersMap =
                            ApiClientUtils.getHeadersMap(httpResponse.getHeaders());
