...
public class StartImportUploadedPartsRequest {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.uploadId, startImportUploadedPartsRequest.uploadId)
                && Objects.equals(this.partETags, startImportUploadedPartsRequest.partETags)
                && Objects.equals(this.name, startImportUploadedPartsRequest.name)
                && Objects.equals(this.autoRename, startImportUploadedPartsRequest.autoRename)
                && Objects.equals(this.pdfOptions, startImportUploadedPartsRequest.pdfOptions)
                && Objects.equals(
                        this.importAsElectronicDocument, startImportUploadedPartsRequest.importAsElectronicDocument)
                && Objects.equals(this.metadata, startImportUploadedPartsRequest.metadata)
                && Objects.equals(this.volumeName, startImportUploadedPartsRequest.volumeName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(
                uploadId, partETags, name, autoRename, pdfOptions, importAsElectronicDocument, metadata, volumeName);
    }
