...
public class EntriesClientImpl extends ApiClient implements EntriesClient {
    ...
    @Override
    public ODataValueContextOfIListOfFieldValue getFieldValues(
            ParametersForGetFieldValues parameters) {
        return doGetFieldValues(
                baseUrl + "/v1/Repositories/{repoId}/Entries/{entryId}/fields", parameters);
    }

    private ODataValueContextOfIListOfFieldValue doGetFieldValues(
            String url, ParametersForGetFieldValues parameters) {
        Map<String, Object> queryParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {
                            "boolean", "String", "String", "String", "int", "int", "boolean"
                        },
                        new String[] {
                            "formatValue",
                            "culture",
        ...
        Function<HttpResponse<Object>, ODataValueContextOfIListOfFieldValue> parseResponse =
                    ...
                    if (httpResponse.getStatus() == 200) {
                        try {
                            ...
                            return objectMapper.readValue(
                                    responseJson, ODataValueContextOfIListOfFieldValue.class);
                        } catch (Exception e) {
    ...
    @Override
    public ODataValueContextOfIListOfFieldValue getFieldValuesNextLink(
            String nextLink, int maxPageSize) {
        return doGetFieldValues(
                nextLink,
                new ParametersForGetFieldValues()
                        .setPrefer(ApiClientUtils.mergeMaxSizeIntoPrefer(maxPageSize, null)));
    }

    @Override
    public void getFieldValuesForEach(
    ...
    @Override
    public ODataValueOfIListOfFieldValue assignFieldValues(
            ParametersForAssignFieldValues parameters) {
        Map<String, Object> queryParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String"},
                        new String[] {"culture"},
                        new Object[] {parameters.getCulture()});
        Map<String, Object> pathParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String", "int"},
                        new String[] {"repoId", "entryId"},
                        new Object[] {parameters.getRepoId(), parameters.getEntryId()});
        Function<HttpResponse<Object>, ODataValueOfIListOfFieldValue> parseResponse =
                (HttpResponse<Object> httpResponse) -> {
                    Object body = httpResponse.getBody();
                    Map<String, String> headersMap =
                            ApiClientUtils.getHeadersMap(httpResponse.getHeaders());
                    if (httpResponse.getStatus() == 200) {
                        try {
                            String responseJson = new JSONObject(body).toString();
                            return objectMapper.readValue(
                                    responseJson, ODataValueOfIListOfFieldValue.class);
                        } catch (Exception e) {
                            throw ApiException.create(
                                    httpResponse.getStatus(), headersMap, null, e);
                        }
        ...
        return ApiClientUtils.sendRequestWithRetry(
                httpClient,
                httpRequestHandler,
                baseUrl + "/v1/Repositories/{repoId}/Entries/{entryId}/fields",
                "PUT",
                "application/json",
    ...
    public CreateEntryResult importDocument(ParametersForImportDocument parameters) {
        ...
        Map<String, Object> pathParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        ...
                        new Object[] {
                            parameters.getRepoId(),
                            parameters.getParentEntryId(),
                        ...
                        });
        {
            ...
            while (retryCount <= maxRetries && shouldRetry) {
                try {
                    ...
                    String requestUrl =
                            ApiClientUtils.beforeSend(
                                    url, headerParametersWithStringTypeValue, httpRequestHandler);
                    httpResponse =
                            httpClient
                                    .post(requestUrl)
                                    .field(
                                            "electronicDocument",
                                            parameters.getInputStream(),
                                            parameters.getContentType() == null
                    ...
                    shouldRetry =
                            httpRequestHandler.afterSend(new ResponseImpl((short) statusCode))
                    ...
                    if (!shouldRetry) {
                        if (httpResponse.getStatus() == 201) {
                            try {
                                ...
                                return objectMapper.readValue(
                                        responseJson, CreateEntryResult.class);
                            } catch (Exception e) {
                                throw ApiException.create(
                                        httpResponse.getStatus(), headersMap, null, e);
                            }
                            ...
                            if (httpResponse.getStatus() == 400
                                    || httpResponse.getStatus() == 404
                                    || httpResponse.getStatus() == 409
                                    ...
                                    if (httpResponse
                                        ...
                                        problemDetails =
                                                ProblemDetails.create(
                                                        httpResponse.getStatus(), headersMap);
                                        CreateEntryResult result =
                                                objectMapper.readValue(
                                                        jsonString, CreateEntryResult.class);
                                        if (result != null && result.getOperations() != null) {
                                            problemDetails
                                                    .getExtensions()
                                                    .put(
                                                            CreateEntryResult.class.getSimpleName(),
                                                            result);
                                            String summary =
                                                    ApiClientUtils.getCreateEntryResultSummary(
                                                            result);
                            ...
                            throw ApiException.create(
                                    httpResponse.getStatus(), headersMap, problemDetails, null);
                        }
                    } else {
    ...
    public ODataValueContextOfIListOfWEntryLinkInfo getLinkValuesFromEntry(
        ...
        return doGetLinkValuesFromEntry(
                baseUrl + "/v1/Repositories/{repoId}/Entries/{entryId}/links", parameters);
    }

    private ODataValueContextOfIListOfWEntryLinkInfo doGetLinkValuesFromEntry(
            String url, ParametersForGetLinkValuesFromEntry parameters) {
        Map<String, Object> queryParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
        ...
        Map<String, String> headerParametersWithStringTypeValue =
                headerParameters.entrySet().stream()
                        .collect(Collectors.toMap(Map.Entry::getKey, e -> (String) e.getValue()));
        Function<HttpResponse<Object>, ODataValueContextOfIListOfWEntryLinkInfo> parseResponse =
                (HttpResponse<Object> httpResponse) -> {
                    Object body = httpResponse.getBody();
                    Map<String, String> headersMap =
                            ApiClientUtils.getHeadersMap(httpResponse.getHeaders());
                    if (httpResponse.getStatus() == 200) {
                        try {
                            String responseJson = new JSONObject(body).toString();
                            return objectMapper.readValue(
                                    responseJson, ODataValueContextOfIListOfWEntryLinkInfo.class);
                        } catch (Exception e) {
                            throw ApiException.create(
                                    httpResponse.getStatus(), headersMap, null, e);
                        }
    ...
    @Override
    public ODataValueContextOfIListOfWEntryLinkInfo getLinkValuesFromEntryNextLink(
            String nextLink, int maxPageSize) {
        return doGetLinkValuesFromEntry(
                nextLink,
                new ParametersForGetLinkValuesFromEntry()
                        .setPrefer(ApiClientUtils.mergeMaxSizeIntoPrefer(maxPageSize, null)));
    }

    @Override
    public void getLinkValuesFromEntryForEach(
    ...
    @Override
    public ODataValueOfIListOfWEntryLinkInfo assignEntryLinks(
            ParametersForAssignEntryLinks parameters) {
        Map<String, Object> pathParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String", "int"},
                        new String[] {"repoId", "entryId"},
                        new Object[] {parameters.getRepoId(), parameters.getEntryId()});
        Function<HttpResponse<Object>, ODataValueOfIListOfWEntryLinkInfo> parseResponse =
                (HttpResponse<Object> httpResponse) -> {
                    Object body = httpResponse.getBody();
                    Map<String, String> headersMap =
                            ApiClientUtils.getHeadersMap(httpResponse.getHeaders());
                    if (httpResponse.getStatus() == 200) {
                        try {
                            String responseJson = new JSONObject(body).toString();
                            return objectMapper.readValue(
                                    responseJson, ODataValueOfIListOfWEntryLinkInfo.class);
                        } catch (Exception e) {
                            throw ApiException.create(
                                    httpResponse.getStatus(), headersMap, null, e);
                        }
        ...
        return ApiClientUtils.sendRequestWithRetry(
                httpClient,
                httpRequestHandler,
                baseUrl + "/v1/Repositories/{repoId}/Entries/{entryId}/links",
                "PUT",
                "application/json",
                parameters.getRequestBody(),
                null,
    ...
    public Entry writeTemplateValueToEntry(ParametersForWriteTemplateValueToEntry parameters) {
        ...
        Map<String, Object> pathParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        ...
                        new String[] {"repoId", "entryId"},
                        new Object[] {parameters.getRepoId(), parameters.getEntryId()});
        Function<HttpResponse<Object>, Entry> parseResponse =
                (HttpResponse<Object> httpResponse) -> {
                    Object body = httpResponse.getBody();
                    Map<String, String> headersMap =
                            ApiClientUtils.getHeadersMap(httpResponse.getHeaders());
        ...
        return ApiClientUtils.sendRequestWithRetry(
                httpClient,
                httpRequestHandler,
                baseUrl + "/v1/Repositories/{repoId}/Entries/{entryId}/template",
                "PUT",
                "application/json",
                parameters.getRequestBody(),
                null,
    ...
    @Override
    public Map<String, String[]> getDynamicFieldValues(
            ParametersForGetDynamicFieldValues parameters) {
        Map<String, Object> pathParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String", "int"},
                        new String[] {"repoId", "entryId"},
                        new Object[] {parameters.getRepoId(), parameters.getEntryId()});
        Function<HttpResponse<Object>, Map<String, String[]>> parseResponse =
                (HttpResponse<Object> httpResponse) -> {
                    Object body = httpResponse.getBody();
                    Map<String, String> headersMap =
                            ApiClientUtils.getHeadersMap(httpResponse.getHeaders());
                    if (httpResponse.getStatus() == 200) {
                        try {
                            String responseJson = new JSONObject(body).toString();
                            return objectMapper.readValue(
                                    responseJson, new HashMap<String, String[]>().getClass());
                        } catch (Exception e) {
                            throw ApiException.create(
                                    httpResponse.getStatus(), headersMap, null, e);
                        }
    ...
    public FindEntryResult getEntryByPath(ParametersForGetEntryByPath parameters) {
        Map<String, Object> queryParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        ...
                        new Object[] {
                            parameters.getFullPath(), parameters.isFallbackToClosestAncestor()
                        });
        Map<String, Object> pathParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String"},
        ...
        Function<HttpResponse<Object>, FindEntryResult> parseResponse =
                (HttpResponse<Object> httpResponse) -> {
                    Object body = httpResponse.getBody();
                    Map<String, String> headersMap =
                            ApiClientUtils.getHeadersMap(httpResponse.getHeaders());
        ...
        return ApiClientUtils.sendRequestWithRetry(
                httpClient,
                httpRequestHandler,
                baseUrl + "/v1/Repositories/{repoId}/Entries/ByPath",
                "GET",
                null,
                null,
                null,
    ...
    public Entry getEntry(ParametersForGetEntry parameters) {
        Map<String, Object> queryParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String"},
                        new String[] {"$select"},
                        new Object[] {parameters.getSelect()});
        Map<String, Object> pathParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String", "int"},
                        new String[] {"repoId", "entryId"},
        ...
        return ApiClientUtils.sendRequestWithRetry(
                httpClient,
                httpRequestHandler,
                baseUrl + "/v1/Repositories/{repoId}/Entries/{entryId}",
                "GET",
                null,
                null,
                null,
    ...
    @Override
    public void exportDocumentWithAuditReason(
        ...
        Map<String, Object> headerParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String"},
                        new String[] {"range"},
                        new Object[] {parameters.getRange()});
        Map<String, String> headerParametersWithStringTypeValue =
                headerParameters.entrySet().stream()
                        .collect(Collectors.toMap(Map.Entry::getKey, e -> (String) e.getValue()));
        {
            ...
            while (retryCount <= maxRetries && shouldRetry) {
                try {
                            ...
                            .thenConsume(
                                    rawResponse -> {
                                        ...
                                        if (rawResponse.getStatus() == 200
                                            ...
                                            Map<String, String> headersMap =
                                                    ApiClientUtils.getHeadersMap(
                                                            rawResponse.getHeaders());
                                            try {
                                                String jsonString =
                                                        rawResponse.getContentAsString();
                                                problemDetails =
                                                        ProblemDetailsDeserializer.deserialize(
                                                                objectMapper, jsonString);
                                            } catch (Exception e) {
                    ...
                    shouldRetry =
                            httpRequestHandler.afterSend(new ResponseImpl((short) statusCode[0]))
                                    || ApiClientUtils.isRetryableStatusCode(
    ...
    @Override
    public InputStream exportDocumentWithAuditReasonAsStream(
            ParametersForExportDocumentWithAuditReason parameters) {
        Map<String, Object> pathParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String", "int"},
    ...
    @Override
    public Map<String, String> getDocumentContentType(
            ParametersForGetDocumentContentType parameters) {
        Map<String, Object> pathParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String", "int"},
                        new String[] {"repoId", "entryId"},
        ...
        Function<HttpResponse<Object>, Map<String, String>> parseResponse =
                (HttpResponse<Object> httpResponse) -> {
                    ...
                    Map<String, String> headersMap =
                            ApiClientUtils.getHeadersMap(httpResponse.getHeaders());
                    if (httpResponse.getStatus() == 200) {
                        return httpResponse.getHeaders().all().stream()
    ...
    public ODataValueOfBoolean deletePages(ParametersForDeletePages parameters) {
        Map<String, Object> queryParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String"},
                        new String[] {"pageRange"},
                        new Object[] {parameters.getPageRange()});
        Map<String, Object> pathParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String", "int"},
                        new String[] {"repoId", "entryId"},
    ...
    @Override
    public ODataValueContextOfIListOfEntry getEntryListing(
    ...
    private ODataValueContextOfIListOfEntry doGetEntryListing(
            String url, ParametersForGetEntryListing parameters) {
        Map<String, Object> queryParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {
                            "boolean",
                ...
                (HttpResponse<Object> httpResponse) -> {
                    ...
                    if (httpResponse.getStatus() == 200) {
                        try {
                            String responseJson = new JSONObject(body).toString();
                            return objectMapper.readValue(
                                    responseJson, ODataValueContextOfIListOfEntry.class);
                        } catch (Exception e) {
                            throw ApiException.create(
                                    httpResponse.getStatus(), headersMap, null, e);
                        }
    ...
    @Override
    public ODataValueContextOfIListOfEntry getEntryListingNextLink(
            String nextLink, int maxPageSize) {
        return doGetEntryListing(
                nextLink,
    ...
    @Override
    public void getEntryListingForEach(
    ...
    @Override
    public ODataValueContextOfIListOfWTagInfo getTagsAssignedToEntry(
            ParametersForGetTagsAssignedToEntry parameters) {
        return doGetTagsAssignedToEntry(
                baseUrl + "/v1/Repositories/{repoId}/Entries/{entryId}/tags", parameters);
    }

    private ODataValueContextOfIListOfWTagInfo doGetTagsAssignedToEntry(
            String url, ParametersForGetTagsAssignedToEntry parameters) {
        Map<String, Object> queryParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        new String[] {"String", "String", "int", "int", "boolean"},
                        new String[] {"$select", "$orderby", "$top", "$skip", "$count"},
                ...
                (HttpResponse<Object> httpResponse) -> {
                    ...
                    if (httpResponse.getStatus() == 200) {
                        try {
                            String responseJson = new JSONObject(body).toString();
                            return objectMapper.readValue(
                                    responseJson, ODataValueContextOfIListOfWTagInfo.class);
                        } catch (Exception e) {
                            throw ApiException.create(
                                    httpResponse.getStatus(), headersMap, null, e);
                        }
    ...
    @Override
    public ODataValueContextOfIListOfWTagInfo getTagsAssignedToEntryNextLink(
            String nextLink, int maxPageSize) {
        return doGetTagsAssignedToEntry(
                nextLink,
                new ParametersForGetTagsAssignedToEntry()
                        .setPrefer(ApiClientUtils.mergeMaxSizeIntoPrefer(maxPageSize, null)));
    }

    @Override
    public void getTagsAssignedToEntryForEach(
    ...
    public ODataValueOfIListOfWTagInfo assignTags(ParametersForAssignTags parameters) {
        Map<String, Object> pathParameters =
                ApiClientUtils.getParametersWithNonDefaultValue(
                        ...
                        new String[] {"repoId", "entryId"},
                        new Object[] {parameters.getRepoId(), parameters.getEntryId()});
        Function<HttpResponse<Object>, ODataValueOfIListOfWTagInfo> parseResponse =
                (HttpResponse<Object> httpResponse) -> {
                    Object body = httpResponse.getBody();
                    Map<String, String> headersMap =
                            ApiClientUtils.getHeadersMap(httpResponse.getHeaders());
                    if (httpResponse.getStatus() == 200) {
                        try {
                            String responseJson = new JSONObject(body).toString();
                            return objectMapper.readValue(
                                    responseJson, ODataValueOfIListOfWTagInfo.class);
                        } catch (Exception e) {
                            throw ApiException.create(
                                    httpResponse.getStatus(), headersMap, null, e);
                        }
        ...
        return ApiClientUtils.sendRequestWithRetry(
                httpClient,
                httpRequestHandler,
                baseUrl + "/v1/Repositories/{repoId}/Entries/{entryId}/tags",
                "PUT",
                "application/json",
                parameters.getRequestBody(),
                null,
