...
public class ParametersForGetFieldValues {
    ...
    /**
     * An optional query parameter used to indicate if the field values should be formatted.<br>            The default value is false.
     *
    ...
    /**
     * An optional query parameter used to indicate the locale that should be used for formatting.<br>            The value should be a standard language tag. The formatValue query parameter must be set to true, otherwise<br>            culture will not be used for formatting.
     *
     * @return {@link String} The return value
     */
