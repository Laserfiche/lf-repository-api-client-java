...
public class ParametersForGetFieldValues {
  ...
  /**
   * Sets the value of the formatValue parameter and returns the current object, to enable chaining
   * further setters.
   *
   ...
   *     formatting. The value should be a standard language tag. The formatValue query parameter
