...
public interface FieldDefinitionsClient {
     ...
     * - Useful when trying to find a list of all field definitions available, rather than only
     * those assigned to a specific entry/template.<br>
     * - Default page size: 100. Allowed OData query options: Select | Count | OrderBy | Skip | Top
     * | SkipToken | Prefer.
     *
     * @param parameters An object of type {@link ParametersForGetFieldDefinitions} which
     *     encapsulates the parameters of {@link #getFieldDefinitions getFieldDefinitions} method.
