...
public interface FieldDefinitionsClient {
    ...
    /**
     * - Returns a single field definition associated with the specified ID. <br>- Useful when a route provides a minimal amount of details and more information about the specific field definition is needed.<br>- Allowed OData query options: Select
     *
