...
public class ApiClient {
    ...
    public ApiClient(String baseUrl, UnirestInstance httpClient) {
        ...
        this.jacksonMapper = JsonMapper.builder().disable(MapperFeature.CAN_OVERRIDE_ACCESS_MODIFIERS).disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES).enable(MapperFeature.ACCEPT_CASE_INSENSITIVE_ENUMS).build();
    }
