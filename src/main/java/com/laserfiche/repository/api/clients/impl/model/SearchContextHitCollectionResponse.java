 ...
 */
@Schema(description = "Response containing a collection of SearchContextHit.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class SearchContextHitCollectionResponse {
    ...
    @JsonProperty("value")
    private List<SearchContextHit> value = null;
    ...
    public SearchContextHitCollectionResponse addValueItem(SearchContextHit valueItem) {
        if (this.value == null) {
            this.value = new ArrayList<SearchContextHit>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SearchContextHitCollectionResponse searchContextHitCollectionResponse = (SearchContextHitCollectionResponse) o;
        return Objects.equals(this.odataNextLink, searchContextHitCollectionResponse.odataNextLink) && Objects.equals(this.odataCount, searchContextHitCollectionResponse.odataCount) && Objects.equals(this.value, searchContextHitCollectionResponse.value);
    }
    ...
    public String toString() {
        ...
        sb.append("class SearchContextHitCollectionResponse {\n");
