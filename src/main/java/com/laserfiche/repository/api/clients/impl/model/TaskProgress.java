...
public class TaskProgress {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, taskProgress.id)
                && Objects.equals(this.taskType, taskProgress.taskType)
                && Objects.equals(this.percentComplete, taskProgress.percentComplete)
                && Objects.equals(this.status, taskProgress.status)
                && Objects.equals(this.errors, taskProgress.errors)
                && Objects.equals(this.result, taskProgress.result)
                && Objects.equals(this.startTime, taskProgress.startTime)
                && Objects.equals(this.lastUpdateTime, taskProgress.lastUpdateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("    lastUpdateTime: ")
                .append(toIndentedString(lastUpdateTime))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
