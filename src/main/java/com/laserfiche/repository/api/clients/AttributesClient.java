...
public interface AttributesClient {
     ...
     * associated with the key within &quot;Everyone&quot; group.<br>
     * - Optional query parameters: everyone (bool, default false). When true, the server only
     * searches for the attribute value with the given key upon the authenticated users attributes.
     * If false, only the authenticated users attributes will be queried.
     *
