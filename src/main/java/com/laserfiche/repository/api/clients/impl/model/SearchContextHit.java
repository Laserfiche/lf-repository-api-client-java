...
public class SearchContextHit {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.hitType, searchContextHit.hitType)
                && Objects.equals(this.isAnnotationHit, searchContextHit.isAnnotationHit)
                && Objects.equals(this.annotationId, searchContextHit.annotationId)
                && Objects.equals(this.pageNumber, searchContextHit.pageNumber)
                && Objects.equals(this.pageOffset, searchContextHit.pageOffset)
                && Objects.equals(this.context, searchContextHit.context)
                && Objects.equals(this.highlight1Offset, searchContextHit.highlight1Offset)
                && Objects.equals(this.highlight1Length, searchContextHit.highlight1Length)
                && Objects.equals(this.highlight2Offset, searchContextHit.highlight2Offset)
                && Objects.equals(this.highlight2Length, searchContextHit.highlight2Length)
                && Objects.equals(this.hitWidth, searchContextHit.hitWidth)
                && Objects.equals(this.edocHitCount, searchContextHit.edocHitCount)
                && Objects.equals(this.fieldHitCount, searchContextHit.fieldHitCount)
                && Objects.equals(this.fieldName, searchContextHit.fieldName)
                && Objects.equals(this.hitNumber, searchContextHit.hitNumber);
    }
