...
/**
 * The encapsulated parameters for {@link com.laserfiche.repository.api.clients.impl.TemplateDefinitionsClientImpl#listTemplateDefinitions(ParametersForListTemplateDefinitions) listTemplateDefinitions}.
 */
public class ParametersForListTemplateDefinitions {
     ...
     * @return {@link ParametersForListTemplateDefinitions} The return value
     */
    public ParametersForListTemplateDefinitions setRepositoryId(String repositoryId) {
     ...
     * @return {@link ParametersForListTemplateDefinitions} The return value
     */
    public ParametersForListTemplateDefinitions setTemplateName(String templateName) {
     ...
     * @return {@link ParametersForListTemplateDefinitions} The return value
     */
    public ParametersForListTemplateDefinitions setPrefer(String prefer) {
        this.prefer = prefer;
        return this;
    }
     ...
     * @return {@link ParametersForListTemplateDefinitions} The return value
     */
    public ParametersForListTemplateDefinitions setCulture(String culture) {
     ...
     * @return {@link ParametersForListTemplateDefinitions} The return value
     */
    public ParametersForListTemplateDefinitions setSelect(String select) {
        this.select = select;
        return this;
    }
     ...
     * @return {@link ParametersForListTemplateDefinitions} The return value
     */
    public ParametersForListTemplateDefinitions setOrderby(String orderby) {
     ...
     * @return {@link ParametersForListTemplateDefinitions} The return value
     */
    public ParametersForListTemplateDefinitions setTop(Integer top) {
        this.top = top;
        return this;
    }
     ...
     * @return {@link ParametersForListTemplateDefinitions} The return value
     */
    public ParametersForListTemplateDefinitions setSkip(Integer skip) {
        this.skip = skip;
        return this;
    }
     ...
     * @return {@link ParametersForListTemplateDefinitions} The return value
     */
    public ParametersForListTemplateDefinitions setCount(Boolean count) {
        this.count = count;
        return this;
    }
