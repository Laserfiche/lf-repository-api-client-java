...
public interface AuditReasonsClient {
     ...
     * are included. - Only includes audit reasons associated with available API functionalities,
     * like delete entry and export document. - If the authenticated user does not have the
     * appropriate Laserfiche feature right, the audit reasons associated with that feature right
