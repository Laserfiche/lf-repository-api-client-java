...
/**
 * The encapsulated parameters for {@link com.laserfiche.repository.api.clients.impl.EntriesClientImpl#listTags(ParametersForListTags) listTags}.
 */
public class ParametersForListTags {
     ...
     * @return {@link ParametersForListTags} The return value
     */
    public ParametersForListTags setRepositoryId(String repositoryId) {
     ...
     * @return {@link ParametersForListTags} The return value
     */
    public ParametersForListTags setEntryId(Integer entryId) {
     ...
     * @return {@link ParametersForListTags} The return value
     */
    public ParametersForListTags setPrefer(String prefer) {
        this.prefer = prefer;
        return this;
    }
     ...
     * @return {@link ParametersForListTags} The return value
     */
    public ParametersForListTags setSelect(String select) {
        this.select = select;
        return this;
    }
     ...
     * @return {@link ParametersForListTags} The return value
     */
    public ParametersForListTags setOrderby(String orderby) {
     ...
     * @return {@link ParametersForListTags} The return value
     */
    public ParametersForListTags setTop(Integer top) {
        this.top = top;
        return this;
    }
     ...
     * @return {@link ParametersForListTags} The return value
     */
    public ParametersForListTags setSkip(Integer skip) {
        this.skip = skip;
        return this;
    }
     ...
     * @return {@link ParametersForListTags} The return value
     */
    public ParametersForListTags setCount(Boolean count) {
        this.count = count;
        return this;
    }
