...
public class AuditReason {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, auditReason.id)
                && Objects.equals(this.name, auditReason.name)
                && Objects.equals(this.auditEventType, auditReason.auditEventType);
    }
    ...
    public String toString() {
        ...
        sb.append("    auditEventType: ")
                .append(toIndentedString(auditEventType))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
