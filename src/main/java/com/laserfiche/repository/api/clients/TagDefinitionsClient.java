...
public interface TagDefinitionsClient {
   ...
   * repository. Useful when trying to display all tag definitions available, not only tags assigned
   * to a specific entry.<br>
  ...
  /**
   * Provides the functionality to iteratively (i.e. through paging) call {@link #getTagDefinitions
   * getTagDefinitions}, and apply a function on the response of each iteration.
   *
   ...
   * Useful when another route provides a minimal amount of details, and more information about the
   * specific tag is needed.<br>
