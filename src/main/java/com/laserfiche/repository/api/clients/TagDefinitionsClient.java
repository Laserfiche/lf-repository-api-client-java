...
public interface TagDefinitionsClient {
    ...
    /**
     * Provides the functionality to iteratively (i.e. through paging) call {@link #getTagDefinitions getTagDefinitions}, and apply a function on the response of each iteration.
     *
    ...
    /**
     * - Returns a single tag definition.<br>- Provide a tag definition ID, and get the single tag definition associated with that ID. Useful when another route provides a minimal amount of details, and more information about the specific tag is needed.<br>- Allowed OData query options: Select
     *
     * @param parameters An object of type {@link ParametersForGetTagDefinitionById} which encapsulates the parameters of {@link #getTagDefinitionById getTagDefinitionById} method.
