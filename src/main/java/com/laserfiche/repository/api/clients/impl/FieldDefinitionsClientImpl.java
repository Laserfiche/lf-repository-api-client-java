...
public class FieldDefinitionsClientImpl extends ApiClient implements FieldDefinitionsClient {
  ...
  public FieldDefinitionsClientImpl(
  ...
  public WFieldInfo getFieldDefinitionById(ParametersForGetFieldDefinitionById parameters) {
    ...
    Function<HttpResponse<Object>, WFieldInfo> parseResponse =
    ...
    return ApiClientUtils.sendRequestWithRetry(
        httpClient,
        httpRequestHandler,
        baseUrl + "/v1/Repositories/{repoId}/FieldDefinitions/{fieldDefinitionId}",
        "GET",
        null,
        null,
        null,
  ...
  @Override
  public ODataValueContextOfIListOfWFieldInfo getFieldDefinitions(
      ParametersForGetFieldDefinitions parameters) {
    return doGetFieldDefinitions(
        baseUrl + "/v1/Repositories/{repoId}/FieldDefinitions", parameters);
  }

  private ODataValueContextOfIListOfWFieldInfo doGetFieldDefinitions(
      String url, ParametersForGetFieldDefinitions parameters) {
    Map<String, Object> queryParameters =
        ApiClientUtils.getParametersWithNonDefaultValue(
    ...
    Function<HttpResponse<Object>, ODataValueContextOfIListOfWFieldInfo> parseResponse =
        (HttpResponse<Object> httpResponse) -> {
          Object body = httpResponse.getBody();
          Map<String, String> headersMap = ApiClientUtils.getHeadersMap(httpResponse.getHeaders());
          if (httpResponse.getStatus() == 200) {
            try {
              ...
              return objectMapper.readValue(
                  responseJson, ODataValueContextOfIListOfWFieldInfo.class);
            } catch (Exception e) {
              throw ApiException.create(httpResponse.getStatus(), headersMap, null, e);
            }
          } else {
  ...
  @Override
  public ODataValueContextOfIListOfWFieldInfo getFieldDefinitionsNextLink(
  ...
  @Override
  public void getFieldDefinitionsForEach(
