...
public class FieldDefinitionsClientImpl extends ApiClient implements FieldDefinitionsClient {
    ...
    private FieldDefinitionCollectionResponse doListFieldDefinitions(
            String url, ParametersForListFieldDefinitions parameters) {
        ...
        Function<HttpResponse<Object>, FieldDefinitionCollectionResponse> parseResponse =
    ...
    public FieldDefinitionCollectionResponse listFieldDefinitionsNextLink(String nextLink, int maxPageSize) {
        return doListFieldDefinitions(
                nextLink,
                new ParametersForListFieldDefinitions()
                        .setPrefer(ApiClientUtils.mergeMaxSizeIntoPrefer(maxPageSize, null)));
    }

    @Override
    public void listFieldDefinitionsForEach(
    ...
    public FieldDefinition getFieldDefinition(ParametersForGetFieldDefinition parameters) {
        ...
        Map<String, Object> pathParameters = ApiClientUtils.getParametersWithNonDefaultValue(
                ...
                new String[] {"repositoryId", "fieldId"},
                new Object[] {parameters.getRepositoryId(), parameters.getFieldId()});
        ...
        return ApiClientUtils.sendRequestWithRetry(
                httpClient,
                httpRequestHandler,
                baseUrl + "/v2/Repositories/{repositoryId}/FieldDefinitions/{fieldId}",
                "GET",
                null,
                null,
                null,
