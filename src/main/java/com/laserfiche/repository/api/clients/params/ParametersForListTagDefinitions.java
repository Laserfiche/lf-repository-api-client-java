...
/**
 * The encapsulated parameters for {@link com.laserfiche.repository.api.clients.impl.TagDefinitionsClientImpl#listTagDefinitions(ParametersForListTagDefinitions) listTagDefinitions}.
 */
public class ParametersForListTagDefinitions {
     ...
     * @return {@link ParametersForListTagDefinitions} The return value
     */
    public ParametersForListTagDefinitions setRepositoryId(String repositoryId) {
     ...
     * @return {@link ParametersForListTagDefinitions} The return value
     */
    public ParametersForListTagDefinitions setPrefer(String prefer) {
        this.prefer = prefer;
        return this;
    }
     ...
     * @return {@link ParametersForListTagDefinitions} The return value
     */
    public ParametersForListTagDefinitions setCulture(String culture) {
     ...
     * @return {@link ParametersForListTagDefinitions} The return value
     */
    public ParametersForListTagDefinitions setSelect(String select) {
        this.select = select;
        return this;
    }
     ...
     * @return {@link ParametersForListTagDefinitions} The return value
     */
    public ParametersForListTagDefinitions setOrderby(String orderby) {
     ...
     * @return {@link ParametersForListTagDefinitions} The return value
     */
    public ParametersForListTagDefinitions setTop(Integer top) {
        this.top = top;
        return this;
    }
     ...
     * @return {@link ParametersForListTagDefinitions} The return value
     */
    public ParametersForListTagDefinitions setSkip(Integer skip) {
        this.skip = skip;
        return this;
    }
     ...
     * @return {@link ParametersForListTagDefinitions} The return value
     */
    public ParametersForListTagDefinitions setCount(Boolean count) {
        this.count = count;
        return this;
    }
