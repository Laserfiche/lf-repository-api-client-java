...
public interface SimpleSearchesClient {
   ...
   * - Search result listing may be truncated, depending on number of results. Additionally,
   * searches may time out if they take too long. Use the other search route to run full searches.
   * <br>
