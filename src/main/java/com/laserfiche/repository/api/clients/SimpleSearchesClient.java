...
public interface SimpleSearchesClient {
   ...
   * full searches. - Optionally returns field values for the entries in the search result listing.
   * Each field name needs to be specified in the request. Maximum limit of 10 field names. - If
   * field values are requested, only the first value is returned if it is a multi value field. -
