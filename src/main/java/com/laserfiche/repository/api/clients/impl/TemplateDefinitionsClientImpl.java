...
public class TemplateDefinitionsClientImpl extends ApiClient implements TemplateDefinitionsClient {
    ...
    public TemplateDefinitionCollectionResponse listTemplateDefinitionsNextLink(String nextLink, int maxPageSize) {
        return doListTemplateDefinitions(nextLink, new ParametersForListTemplateDefinitions().setPrefer(ApiClientUtils.mergeMaxSizeIntoPrefer(maxPageSize, null)));
    }

    @Override
    public void listTemplateDefinitionsForEach(Function<TemplateDefinitionCollectionResponse, Boolean> callback, Integer maxPageSize, ParametersForListTemplateDefinitions parameters) {
    ...
    @Override
    public TemplateFieldDefinitionCollectionResponse listTemplateFieldDefinitionsByTemplateName(ParametersForListTemplateFieldDefinitionsByTemplateName parameters) {
        return doListTemplateFieldDefinitionsByTemplateName(baseUrl + "/v2/Repositories/{repositoryId}/TemplateDefinitions/FieldDefinitions", parameters);
    }
    ...
    private TemplateFieldDefinitionCollectionResponse doListTemplateFieldDefinitionsByTemplateName(String url, ParametersForListTemplateFieldDefinitionsByTemplateName parameters) {
        ...
        Function<HttpResponse<Object>, TemplateFieldDefinitionCollectionResponse> parseResponse = (HttpResponse<Object> httpResponse) -> {
            ...
            if (httpResponse.getStatus() == 200) {
                try {
                    String responseJson = new JSONObject(body).toString();
                    return objectMapper.readValue(responseJson, TemplateFieldDefinitionCollectionResponse.class);
                } catch (Exception e) {
                    throw ApiException.create(httpResponse.getStatus(), headersMap, null, e);
                }
            } else {
    ...
    @Override
    public TemplateFieldDefinitionCollectionResponse listTemplateFieldDefinitionsByTemplateNameNextLink(String nextLink, int maxPageSize) {
        return doListTemplateFieldDefinitionsByTemplateName(nextLink, new ParametersForListTemplateFieldDefinitionsByTemplateName().setPrefer(ApiClientUtils.mergeMaxSizeIntoPrefer(maxPageSize, null)));
    }

    @Override
    public void listTemplateFieldDefinitionsByTemplateNameForEach(Function<TemplateFieldDefinitionCollectionResponse, Boolean> callback, Integer maxPageSize, ParametersForListTemplateFieldDefinitionsByTemplateName parameters) {
        parameters.setPrefer(ApiClientUtils.mergeMaxSizeIntoPrefer(maxPageSize, parameters.getPrefer()));
    ...
    public TemplateDefinition getTemplateDefinition(ParametersForGetTemplateDefinition parameters) {
        ...
        return ApiClientUtils.sendRequestWithRetry(httpClient, httpRequestHandler, baseUrl + "/v2/Repositories/{repositoryId}/TemplateDefinitions/{templateId}", "GET", null, null, null, null, queryParameters, pathParameters, new HashMap<String, String>(), false, parseResponse);
    }

    @Override
    public TemplateFieldDefinitionCollectionResponse listTemplateFieldDefinitionsByTemplateId(ParametersForListTemplateFieldDefinitionsByTemplateId parameters) {
        return doListTemplateFieldDefinitionsByTemplateId(baseUrl + "/v2/Repositories/{repositoryId}/TemplateDefinitions/{templateId}/FieldDefinitions", parameters);
    }
    ...
    @Override
    public TemplateFieldDefinitionCollectionResponse listTemplateFieldDefinitionsByTemplateIdNextLink(String nextLink, int maxPageSize) {
        return doListTemplateFieldDefinitionsByTemplateId(nextLink, new ParametersForListTemplateFieldDefinitionsByTemplateId().setPrefer(ApiClientUtils.mergeMaxSizeIntoPrefer(maxPageSize, null)));
    }

    @Override
    public void listTemplateFieldDefinitionsByTemplateIdForEach(Function<TemplateFieldDefinitionCollectionResponse, Boolean> callback, Integer maxPageSize, ParametersForListTemplateFieldDefinitionsByTemplateId parameters) {
        parameters.setPrefer(ApiClientUtils.mergeMaxSizeIntoPrefer(maxPageSize, parameters.getPrefer()));
