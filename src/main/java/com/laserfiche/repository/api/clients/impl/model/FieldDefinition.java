...
public class FieldDefinition {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.name, fieldDefinition.name)
                && Objects.equals(this.displayName, fieldDefinition.displayName)
                && Objects.equals(this.id, fieldDefinition.id)
                && Objects.equals(this.description, fieldDefinition.description)
                && Objects.equals(this.fieldType, fieldDefinition.fieldType)
                && Objects.equals(this.length, fieldDefinition.length)
                && Objects.equals(this.defaultValue, fieldDefinition.defaultValue)
                && Objects.equals(this.isMultiValue, fieldDefinition.isMultiValue)
                && Objects.equals(this.isRequired, fieldDefinition.isRequired)
                && Objects.equals(this.constraint, fieldDefinition.constraint)
                && Objects.equals(this.constraintError, fieldDefinition.constraintError)
                && Objects.equals(this.listValues, fieldDefinition.listValues)
                && Objects.equals(this.format, fieldDefinition.format)
                && Objects.equals(this.currency, fieldDefinition.currency)
                && Objects.equals(this.formatPattern, fieldDefinition.formatPattern);
    }
