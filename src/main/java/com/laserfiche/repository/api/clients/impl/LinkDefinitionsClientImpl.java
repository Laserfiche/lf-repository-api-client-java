...
public class LinkDefinitionsClientImpl extends ApiClient implements LinkDefinitionsClient {
    ...
    public LinkDefinitionsClientImpl(
    ...
    public EntryLinkTypeInfo getLinkDefinitionById(ParametersForGetLinkDefinitionById parameters) {
        ...
        Function<HttpResponse<Object>, EntryLinkTypeInfo> parseResponse =
    ...
    @Override
    public ODataValueContextOfIListOfEntryLinkTypeInfo getLinkDefinitions(
            ParametersForGetLinkDefinitions parameters) {
        return doGetLinkDefinitions(
                baseUrl + "/v1/Repositories/{repoId}/LinkDefinitions", parameters);
    }
    ...
    @Override
    public ODataValueContextOfIListOfEntryLinkTypeInfo getLinkDefinitionsNextLink(
