...
public class ParametersForImportDocument {
   ...
   *     value should be a standard language tag. This may be used when setting field values with
   *     tokens.
   * @return {@link ParametersForImportDocument} The return value
   */
  ...
  /**
   * Sets the value of the contentType parameter and returns the current object, to enable chaining
   * further setters.
   *
   * @return {@link ParametersForImportDocument} The return value
   */
  ...
  /**
   * Sets the value of the inputStream parameter and returns the current object, to enable chaining
   * further setters.
   *
   * @return {@link ParametersForImportDocument} The return value
   */
