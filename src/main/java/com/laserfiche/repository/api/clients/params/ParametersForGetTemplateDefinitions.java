...
public class ParametersForGetTemplateDefinitions {
  ...
  /**
   * An optional query parameter. Can be used to get a single template definition using the template
   * name.
   */
  ...
  /**
   * Sets the value of the templateName parameter and returns the current object, to enable chaining
   * further setters.
   *
   ...
   * @return {@link ParametersForGetTemplateDefinitions} The return value
   */
  public ParametersForGetTemplateDefinitions setTop(Integer top) {
    this.top = top;
    return this;
  }
   ...
   * @return {@link ParametersForGetTemplateDefinitions} The return value
   */
  public ParametersForGetTemplateDefinitions setSkip(Integer skip) {
    this.skip = skip;
    return this;
  }
