...
public class ParametersForMoveOrRenameEntry {
     ...
     *     automatically renamed if another entry already exists with the same name in the folder.
     ...
     * renamed if another entry already exists with the same name in the folder. The default value
     * is false.
     *
