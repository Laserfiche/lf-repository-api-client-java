 ...
 * com.laserfiche.repository.api.clients.impl.EntriesClientImpl#moveOrRenameEntry(ParametersForMoveOrRenameEntry)
 * moveOrRenameEntry}.
 */
public class ParametersForMoveOrRenameEntry {
   ...
   * further setters.
   *
   * @param autoRename An optional query parameter used to indicate if the entry should be
   *     automatically renamed if another entry already exists with the same name in the folder. The
   ...
   * further setters.
   *
   * @param culture An optional query parameter used to indicate the locale that should be used. The
