    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          ...
          .registerTypeSelector(ODataValueOfIListOfEntry.class, new TypeSelector() {
            ...
            public Class getClassForElement(JsonElement readElement) {
                Map classByDiscriminatorValue = new HashMap();
                classByDiscriminatorValue.put("ODataValueContextOfIListOfEntry".toUpperCase(), ODataValueContextOfIListOfEntry.class);
                classByDiscriminatorValue.put("ODataValueOfIListOfEntry".toUpperCase(), ODataValueOfIListOfEntry.class);
                return getClassByDiscriminator(
                            classByDiscriminatorValue,
                            getDiscriminatorValue(readElement, ""));
            }
