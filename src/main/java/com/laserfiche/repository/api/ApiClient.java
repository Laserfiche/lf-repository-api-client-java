...
import com.laserfiche.repository.api.auth.HttpBasicAuth;
import com.laserfiche.repository.api.auth.ApiKeyAuth;
import com.laserfiche.repository.api.auth.OAuth;
import com.laserfiche.repository.api.auth.OAuth.AccessTokenListener;
import com.laserfiche.repository.api.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      } else if ("OAuth2 Authorization Code Flow".equals(authName)) {
        auth = new OAuth(OAuthFlow.accessCode, "https://signin.a.clouddev.laserfiche.com/oauth/Authorize", "https://signin.a.clouddev.laserfiche.com/oauth/Token", "");
      } else if ("OAuth2 Client Credentials Flow".equals(authName)) {
      } else {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://api.a.clouddev.laserfiche.com/repository";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
