...
public class CreateCopyEntryApiTest extends BaseTest {
    ...
    void createCopyEntry_CreateShortcut() {
        ...
        Entry targetEntry =
                createEntry(createEntryClient, newEntryName, testClassParentFolder.getId(), true);
    ...
    void copyEntryAsync_CopyEntry() throws InterruptedException {
        ...
        AcceptedOperation copyEntryResponse =
                client.copyEntryAsync(
                        new ParametersForCopyEntryAsync()
                                .setRepoId(repositoryId)
                                .setEntryId(testClassParentFolder.getId())
        ...
        OperationProgress getOperationStatusAndProgressResponse =
                repositoryApiClient
                        .getTasksClient()
    ...
    void createCopyEntry_CopyShortCut() {
        ...
        Entry createOrCopyEntryResponse =
                client.createOrCopyEntry(
                        new ParametersForCreateOrCopyEntry()
                                .setRepoId(repositoryId)
                                .setEntryId(testClassParentFolder.getId())
    ...
    void moveAndRenameEntry_ReturnEntry() {
        ...
        Entry movedEntry =
                client.moveOrRenameEntry(
                        new ParametersForMoveOrRenameEntry()
                                .setRepoId(repositoryId)
