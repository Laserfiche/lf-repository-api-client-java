...
class TagDefinitionsApiTest extends BaseTest {
    ...
    void getTagDefinitions_NextLink() throws InterruptedException {
        ...
        ODataValueContextOfIListOfWTagInfo nextLinkResponse =
                client.getTagDefinitionsNextLink(nextLink, maxPageSize);
    ...
    void getTagDefinitionById_ReturnTag() {
        ...
        WTagInfo tagInfo =
                client.getTagDefinitionById(
                        new ParametersForGetTagDefinitionById()
                                .setRepoId(repositoryId)
